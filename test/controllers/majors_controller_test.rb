...
class MajorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create major" do
    assert_difference('Major.count') do
      post majors_url, params: { major: { book_end: @major.book_end, book_start: @major.book_start, name: @major.name, notice: @major.notice } }
    end
  ...
  test "should update major" do
    patch major_url(@major), params: { major: { book_end: @major.book_end, book_start: @major.book_start, name: @major.name, notice: @major.notice } }
